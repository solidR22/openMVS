...
bool read_mvs_pose(string file,MVSPOSE &mvs_pose)
{
	...
	RGB color(0,255,0);
    save_pointcloud_obj("/home/silab/Datasets/3DReco/SLAM2MVS/track_platform.obj", points, mvs_pose.poses.size(), color);
...
//		mvs_pose.views[i].reserve(num_keys);
    ...
    save_pointcloud_obj("/home/silab/Datasets/3DReco/SLAM2MVS/track.obj", points,mvs_pose.poses.size(),color);
	return true;
}
